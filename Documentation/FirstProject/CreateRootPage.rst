...
You need a `Site configuration <https://docs.typo3.org/permalink/t3start:site-management>`_.
If you started in a freshly installed TYPO3 installation the site configuration
was auto-created and you can edit it:
...
..  figure:: /Images/ManualScreenshots/CreateRootPage/AutogeneratedSiteConfig.png
    ...
    You can find the auto-generated site for your root page in the module :guilabel:`Site Management > Sites`
...
The site needs a theme, called "site package" in the TYPO3 world.
See chapter
`site package <https://docs.typo3.org/permalink/t3start:creating-a-site-package>`_.

..  admonition:: Trouble shooting

    TYPO3 does not come with a default theme you need to install
    or create a site package. Otherwise you will see a message like the
    following when trying to display the page in the frontend:
    ...
    *   Use the `Introduction Package <https://docs.typo3.org/permalink/t3start:introductionpackage-index>`_
        with a ready to use theme and predefined content.
