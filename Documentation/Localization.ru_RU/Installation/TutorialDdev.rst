...
Сценарии, используемые в данном руководстве, устанавливают TYPO3 v13.1, являющуюся последней версией CMS. Если необходимо установить версию TYPO3 с долгосрочной поддержкой (LTS), посетите сайт :ref:`TYPO3 v12 Installation instructions <t3start12:install>`.
