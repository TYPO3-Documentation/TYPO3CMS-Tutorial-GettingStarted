...
Read the :ref:`t3sitepackage:start` (available since version 8.7) to learn how to do this.
...
While the already mentioned :ref:`t3sitepackage:start` (since v8.7) teaches you the TypoScript
